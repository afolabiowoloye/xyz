...
selected = option_menu(
    ...
    options = ['Home', 'EGFR', 'ER', 'HER2', 'PR', 'PI3K', 'VEGFR2', 'mTOR', 'PARP1', 'AKT', 'ATM', 'FGFR1', 'Braf', 'HDAC1', 'HDAC2', 'HDAC8',
