...
if selected == "Home":
    ...
    with st.sidebar.header("""Overview and Usage"""):
        ...
        Ready to explore? Click your <strong>target of choice</strong> button to begin your journey toward discovering potent breast cancer inhibitors. If you have any questions or need assistance, please contact us.
        """, unsafe_allow_html=True)
...
## Braf
    ...
    # Link to the dataset on Google Drive
        ...
        # Plotting
        fig, ax = plt.subplots()
        sns.regplot(x=y_test, y=y_pred, scatter_kws={'alpha': 0.3, 'color': 'darkgreen'}, line_kws={'color':'deeppink'}, ax=ax)
        ax.set_xlabel('Experimental pIC50')
        ax.set_ylabel('Predicted pIC50')
        ax.set_xlim(3.5, 10.5)
        ax.set_ylim(3.5, 10.5)
