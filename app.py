...
if selected == "Select Target":
    ...
    if selected_target == "Click to select a target":
        st.markdown("""
        <h6 style='color: red;'<strong>Note:</strong>pIC<sub>50</sub> is the negative log of the IC<sub>50</sub> value, offering a logarithmic measure of compound potency</h6>
        """, unsafe_allow_html=True)
